...
int main() {
    int arr[100], n = 0, i, j, temp, count_even = 0, count_odd = 0, second_largest, pos, value, key, found;
    
    while (1) {
        printf("\n===== MENU =====\n");
        printf("1. Nhap so phan tu va gia tri cho mang\n");
        printf("2. In gia tri cac phan tu trong mang\n");
        printf("3. Kiem tra cac so nguyen trong mang\n");
        ...
        switch (choice) {
            ...
            case 3:
                if (n == 0) {
                    ...
                    printf("Cac so nguyen trong mang:\n");
                    for (i = 0; i < n; i++) {
                        if (arr[i] == (int)arr[i]) {
                            printf("arr[%d] = %d\n", i, arr[i]);
                        }
